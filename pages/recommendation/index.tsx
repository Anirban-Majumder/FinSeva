...
const images = [
  "https://i.postimg.cc/gjxWfZdc/saving.png", // Default image
  "https://i.postimg.cc/y82zKDKm/pic1-1.png",
  "https://i.postimg.cc/g0K4D7gx/pic2-1.png",
  "https://i.postimg.cc/XNrmjV2x/pic3-1.jpg",
  "https://i.postimg.cc/prvF6Vyx/pic4-1.png",
  "https://i.postimg.cc/VvtKjkp8/pic5-1.png",
  "https://i.postimg.cc/dt8W3DGR/pic6-1.png",
]
    ...
    <DefaultLayout>
      <div className="flex items-center justify-center min-h-screen">
        <Card
          ...
          style={{ width: "400px", height: "620px", position: "relative", overflow: "hidden" }}
        >
          ...
          <img
            src={images[currentTip] || "/placeholder.svg"}
            alt={`Recommendation ${currentTip + 1}`}
            className="mx-auto mt-4 max-w-full max-h-64 object-contain"
          />
        </Card>
      </div>
    </DefaultLayout>
